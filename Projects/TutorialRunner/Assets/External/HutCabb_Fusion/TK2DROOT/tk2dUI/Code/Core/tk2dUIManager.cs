...
public class tk2dUIManager : MonoBehaviour
{
    ...
    public static int releaseId = -6; // < -10000 = alpha, other negative = beta release, 0 = final, positive = final patch
...
#pragma warning restore 649
    ...
    /// <summary>
    /// On mouse wheel change (return direction of mouse wheel change)
    /// </summary>
    public event System.Action<float> OnMouseWheelChange;
