...
public class tk2dUIMask : MonoBehaviour {
	...
	void OnDrawGizmosSelected() {
		...
		if (mesh != null) {
			...
			Vector3 center = transform.TransformPoint(new Vector3(bounds.center.x, bounds.center.y, d * 0.5f));
			Vector3 size = transform.TransformDirection(new Vector3(bounds.extents.x * 2, bounds.extents.y * 2, Mathf.Abs(d)));
